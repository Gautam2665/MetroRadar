# TransitOS Certification Audit — DMRC (Delhi-NCR)
...
| **Operator Network** | Delhi Metro Rail Corporation |
| **Source Type** | `OFFICIAL` |
| **Trust Tier** | `TIER_A` |
| **Portal Source** | [https://transportstack.delhi.gov.in](https://transportstack.delhi.gov.in) |
| **License** | Open Government License (OGL-India) |
| **Lifecycle Status** | `IMPORTED` |
| **Dataset Version** | `v1.0.0` |
| **Feed Version** | `2026.07` |
| **SHA-256 Checksum** | `bd184a7e13907a223032b3b7886babe52ac16b6149f8404f508712b87492fc1b` |
...
- **Backup Source**: `TDSE`
- **Audit Notes**: Primary portal: transportstack.delhi.gov.in. Authoritative official feed.
