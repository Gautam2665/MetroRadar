...
export default function AlertsPage() {
  ...
  const alertsList = [
    ...
    {
      id: "alert-2",
      title: "Yellow Line - Minor Track Speed Control",
      time: "45 MINS AGO",
    ...
    },
    {
      ...
      time: "2 HRS AGO",
      description: `Escalator #2 under maintenance at ${currentMeta.quickPills[0] || "Rajiv Chowk"}. Please use elevators at Gate C.`,
      type: "info",
      borderColor: "border-l-[#00e5ff]",
      iconBg: "bg-[#00e5ff]/20",
      iconColor: "text-[#00e5ff]",
      icon: "build",
      tag: currentMeta.quickPills[0] || "Rajiv Chowk",
      tagColor: "#31353e",
