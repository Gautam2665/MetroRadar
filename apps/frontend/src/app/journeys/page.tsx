...
export default function MyJourneysPage() {
  ...
  const savedCommutes = [
    {
      ...
      icon: "work",
      from: currentMeta.upcomingJourney.from,
      to: currentMeta.upcomingJourney.to,
      status: "On Time",
      statusColor: "#4ade80",
      avgDuration: "32 mins",
      transfers: "1 Transfer",
      lines: currentMeta.lines,
    ...
    },
    {
      ...
      lines: [currentMeta.lines[0] || { name: "Express Line", code: "EXP", color: "#F97316" }],
    ...
    },
    {
      ...
      lines: [currentMeta.lines[1] || currentMeta.lines[0]],
  ...
  const pastTrips = [
    ...
    },
    {
      ...
      from: currentMeta.upcomingJourney.to,
      to: currentMeta.upcomingJourney.from,
